...
# Store whole Python script for patching binaries in here, because it's
# not in conda build yet yet.
cat > patchbinary.py <<"EOF"
#!/usr/bin/env python
'''
...
# Tidy up
rm $PREFIX/patchbinary.py
rm $PREFIX/.build_prefix.a
